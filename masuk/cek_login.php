        ...
        if (mysqli_num_rows($result) === 1) {
            ...
            if (password_verify($password, $hashedPassword)) {
              ...
              $login = mysqli_query(
                ...
                "SELECT * FROM admin WHERE username='$_POST[username]' AND password='$hashedPassword' AND blokir='N'" );
              ...
              if ($ketemu > 0) {
                ...
                echo "<div class='error msg'>Login Gagal, Password salah, atau account anda sedang di blokir. ";

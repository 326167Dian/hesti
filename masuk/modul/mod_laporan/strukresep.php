...
//HEADER 1
$pdf->Line(0,2, 8, 2); //horisontal bawah

$pdf->Line(0, 3.8, 8, 3.8); //judul tabel atas
...
$pdf->Cell(0, 0.3,'Apoteker : '. $rh['empat'], 0, 1, 'C');
...
$pdf->Cell(6, 0.6,'_______________________________________________________', 0, 0, 'C');

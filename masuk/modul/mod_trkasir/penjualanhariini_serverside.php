            ...
            if($_SESSION['level'] == 'pemilik'){
                ...
                $nestedData['pilih'] = '<div class="dropdown">
                                          ...
                                          <div class="dropdown-menu">
                                            ...
                                            <a href="modul/mod_laporan/faktur.php?kd_trkasir='.$value['kd_trkasir'].'" target="_blank" title="FAKTUR" class="btn btn-primary btn-xs" style="width:50%; margin:0 3  5">FAKTUR</a>

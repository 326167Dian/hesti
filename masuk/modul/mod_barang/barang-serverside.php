...
if ($_GET['action'] == "table_data") {
    ...
    if (!empty($query)) {
        ...
        while ($value = $query->fetch_array()) {
            ...
            $nestedData['hrgjual_barang1']  = $value['hrgjual_barang'];
            $nestedData['hrgjual_barang2']  = $value['hrgjual_barang1'];
            $nestedData['hrgjual_barang3']  = $value['hrgjual_barang2'];
            $nestedData['hrgjual_barang4']  = $value['hrgjual_barang3'];
            $nestedData['hrgjual_barang5']  = $value['hrgjual_barang4'];
            $nestedData['hrgjual_barang6']  = $value['hrgjual_barang5'];
            $nestedData['hna']              = $value['hna'];
            $nestedData['konversi']         = $value['konversi'];
            $nestedData['diskon']           = $value['diskon'];
